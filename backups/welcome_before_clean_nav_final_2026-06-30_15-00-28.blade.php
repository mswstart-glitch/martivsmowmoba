...
.hero{
    ...
    background:
        ...
        url("https://images.unsplash.com/photo-1492144534655-ae79c964c9d?auto=format&fit=crop&w=2200&q=90");
...
<style id="smooth-fast-premium-motion">
.card,
.package,
.result-card,
.cta-box,
...
<style id="force-hero-photo-visible">
.hero{
    ...
    background:
        ...
        url("/autoschool/images/hero-driving-school.webp") !important;
...
<style id="premium-polish-v2">
    ...
    header,
    .navbar{
        transition: all .34s cubic-bezier(.2,.8,.2,1) !important;
    }
    ...
    .navbar:hover{
        ...
        box-shadow: 0 24px 70px rgba(39,111,255,.18) !important;
    }
    ...
    h1{
        text-shadow:0 18px 55px rgba(0,0,0,.28) !important;
    }
    ...
    .nav-cta:hover{
        ...
        box-shadow:0 22px 55px rgba(47,128,255,.32) !important;
    }
    ...
    .simulator-card{
        position:relative !important;
        overflow:hidden !important;
        border:1px solid rgba(92,162,255,.32) !important;
        box-shadow:
            0 30px 90px rgba(0,0,0,.34),
            0 0 0 1px rgba(255,255,255,.06) inset,
            0 0 65px rgba(47,128,255,.22) !important;
    ...
    .simulator-card:hover{
        ...
        box-shadow:
            ...
            0 0 90px rgba(47,128,255,.34) !important;
    }
    ...
    .simulator-card::after{
        ...
        pointer-events:none;
        background:
            radial-gradient(circle at 20% 0%, rgba(92,162,255,.22), transparent 35%),
    ...
    .quiz-option:hover{
        ...
        border-color:rgba(47,128,255,.72) !important;
        box-shadow:0 14px 34px rgba(47,128,255,.18) !important;
    }
    ...
    .hero-stats{
        ...
        border:1px solid rgba(47,128,255,.13) !important;
        box-shadow:0 30px 80px rgba(21,71,140,.14) !important;
    }
    ...
    .stat-item:hover{
        ...
        background:rgba(240,247,255,.86) !important;
        box-shadow:0 18px 45px rgba(47,128,255,.14) !important;
    }
    ...
    .service-card{
        ...
        border-color:rgba(47,128,255,.13) !important;
    }
    ...
    .service-card:hover{
        ...
        box-shadow:0 28px 70px rgba(47,128,255,.14) !important;
    }

    .icon,
    .feature-icon,
    .stat-icon{
        background:linear-gradient(135deg,#2f80ff,#0b5cff) !important;
        box-shadow:0 16px 34px rgba(47,128,255,.28) !important;
    }
...
<style id="creative-premium-navbar-v10">
    .nav{
        ...
        background:
            linear-gradient(135deg, rgba(255,255,255,.86), rgba(238,247,255,.74)) !important;

        border:1px solid rgba(52,120,255,.20) !important;

        backdrop-filter:blur(26px) saturate(180%) !important;
        -webkit-backdrop-filter:blur(26px) saturate(180%) !important;

        box-shadow:
            0 24px 70px rgba(23,78,155,.18),
            0 8px 24px rgba(10,35,80,.08),
    ...
    .nav::before{
        ...
        pointer-events:none !important;
        background:
            linear-gradient(135deg, rgba(255,255,255,.72), rgba(255,255,255,.18)) !important;
    ...
    .brand-mark{
        ...
        background:
            ...
            linear-gradient(135deg,#69b8ff,#2368ff) !important;
        box-shadow:
            0 14px 28px rgba(47,128,255,.30),
    ...
    .nav-links a:hover{
        ...
        background:rgba(232,242,255,.95) !important;
        transform:none !important;
    ...
    .nav-cta{
        ...
        background:
            ...
            linear-gradient(135deg,#3b8dff,#1557e8) !important;

        box-shadow:
            0 14px 34px rgba(47,128,255,.34),
    ...
    .nav-cta:hover{
        color:#ffffff !important;
        background:
            radial-gradient(circle at 28% 18%, rgba(255,255,255,.48), transparent 32%),
            linear-gradient(135deg,#4b98ff,#1d63ff) !important;
        box-shadow:
            0 18px 42px rgba(47,128,255,.43),
...
<!-- AUTOSCHOOL_NAVBAR_PREMIUM_START -->
<style>
    body {
    ...
    [data-navbar] {
        ...
        background:
            linear-gradient(135deg, rgba(255,255,255,.92), rgba(239,246,255,.78)) !important;
        box-shadow:
    ...
    [data-navbar]::before {
        ...
        pointer-events: none !important;
        background: linear-gradient(90deg, rgba(37,99,235,.10), transparent 36%, rgba(14,165,233,.12)) !important;
    }
    ...
    body > nav a[href*="tel"],
    body > header nav a[href*="tel"],
    .navbar a[href*="tel"],
    .site-navbar a[href*="tel"],
    .nav-bar a[href*="tel"],
    [data-navbar] a[href*="tel"] {
        color: #ffffff !important;
...
<script id="smooth-fast-premium-motion-js">
document.addEventListener('DOMContentLoaded', () => {
    if(!window.gsap || !window.ScrollTrigger) return;

    gsap.registerPlugin(ScrollTrigger);

    if(document.querySelector('.after-hero-road-bg')){
    ...
    ['.grid-4', '.packages', '.results'].forEach(selector => {
...
<script id="premium-polish-gsap-v2">
document.addEventListener("DOMContentLoaded", function(){
    if (typeof gsap === "undefined") return;

    gsap.to(".nav, header, .navbar", {
        scrollTrigger: {
            trigger: "body",
            start: "top -40",
    ...
    gsap.to(".hero-card, .quiz-card, .exam-card, .simulator-card", {
        y: -28,
        ease: "none",
        scrollTrigger: {
            trigger: ".hero",
    ...
    gsap.utils.toArray(".stat, .stat-item").forEach(function(el, i){
        gsap.from(el, {
            y: 18,
            opacity: 0,
            duration: .48,
...
<script id="creative-premium-navbar-lock-v10">
(function(){
    function lockNav(){
        ...
        nav.style.setProperty("top","22px","important");
        ...
        nav.style.setProperty("animation","none","important");
    ...
    document.addEventListener("DOMContentLoaded", lockNav);
    window.addEventListener("load", lockNav);
    window.addEventListener("scroll", lockNav, {passive:true});
})();
</script>

<!-- AUTOSCHOOL_NAVBAR_GSAP_LOCK_START -->
<script>
    (function () {
        function lockAutoschoolNavbar() {
            var selectors = [
                'body > nav',
                'body > header nav',
                '.navbar',
            ...
            if (window.gsap && nodes.length) {
                ...
                nodes.forEach(function (node) {
                    window.gsap.set(node, {
                        clearProps: 'x,y,scale,rotation,opacity,visibility'
                    });
                    node.style.transform = 'translateX(-50%)';
                    node.style.opacity = '1';
                    node.style.visibility = 'visible';
        ...
        document.addEventListener('DOMContentLoaded', lockAutoschoolNavbar);
        window.addEventListener('load', lockAutoschoolNavbar);
        setTimeout(lockAutoschoolNavbar, 250);
        setTimeout(lockAutoschoolNavbar, 1000);
    })();
</script>
<!-- AUTOSCHOOL_NAVBAR_GSAP_LOCK_END -->
