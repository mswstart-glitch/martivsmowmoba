...
<head>
    ...
    <style>
        *{box-sizing:border-box}
        ...
        .red-step span{background:var(--red);box-shadow:0 0 22px rgba(239,68,68,.7)}
        .yellow-step span{background:var(--yellow);box-shadow:0 0 22px rgba(250,204,21,.7)}
        .green-step span{background:var(--green);box-shadow:0 0 22px rgba(34,197,94,.7)}
        .signal-line{
            height:2px;
        ...
        .slide.red-slide .slide-light{background:var(--red);color:var(--red)}
        .slide.yellow-slide .slide-light{background:var(--yellow);color:var(--yellow)}
        .slide.green-slide .slide-light{background:var(--green);color:var(--green)}
        .slider-dots{
            display:flex;
        ...
        @media(max-width:950px){.links{display:none}h1{font-size:44px;letter-spacing:-1.4px}.exam,.cards,.flow,.preview-stats,.signal-hero{grid-template-columns:1fr}.title,.cta{display:block}.title h2{font-size:36px}.cta a{display:inline-flex;margin-top:22px}.url{display:none}.screen{border-radius:28px}.signal-line{display:none}.traffic-slider{min-height:210px}.slide{grid-template-columns:1fr;text-align:center}.slide h3,.slide p{text-align:center}.slide-light{margin:auto}.slide-code{font-size:28px}.searchbox b{font-size:16px}.center{padding-top:38px}}
    </style>
</head>
<body>
...
<section class="hero">
    ...
    <div class="container">
        ...
        <div class="center">
            ...
            <h1>გაჩერდი. ისწავლე. <span>გააგრძელე.</span></h1>

            <p class="lead">
                მართვის მოწმობის ტესტები შუქნიშნის ლოგიკით — წითელი შეცდომისთვის,
                ყვითელი ახსნისთვის, მწვანე პროგრესისთვის.
            </p>

            <div class="traffic-slider">
                <div class="slide red-slide active">
                    <div class="slide-light"></div>
                    <div>
                        <h3>შეცდომა არ არის დასასრული</h3>
                        <p>წითელი გაჩერებს და გაჩვენებს, სად შეცდი.</p>
                    </div>
                    <div class="slide-code">STOP</div>
                </div>

                <div class="slide yellow-slide">
                    <div class="slide-light"></div>
                    <div>
                        <h3>ახსნა არის სწავლის მომენტი</h3>
                        <p>ყვითელი გაძლევს მარტივ განმარტებას და გიმზადებს შემდეგ კითხვაზე.</p>
                    </div>
                    <div class="slide-code">LEARN</div>
                </div>

                <div class="slide green-slide">
                    <div class="slide-light"></div>
                    <div>
                        <h3>მწვანე ნიშნავს პროგრესს</h3>
                        <p>სწორი პასუხი გაძლევს გზას გამოცდის წარმატებით ჩაბარებისკენ.</p>
                    </div>
                    <div class="slide-code">GO</div>
                </div>
            </div>
