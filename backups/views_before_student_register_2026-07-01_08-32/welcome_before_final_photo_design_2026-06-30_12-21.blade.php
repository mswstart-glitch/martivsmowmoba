...
.hero{
    ...
    color:#fff;
    background:
        linear-gradient(90deg,rgba(7,17,31,.88) 0%,rgba(7,17,31,.58) 48%,rgba(7,17,31,.30) 100%),
...
.real-road-bg{
    ...
    opacity:0;
    background:
        linear-gradient(180deg,rgba(248,250,252,.96) 0%,rgba(248,250,252,.82) 22%,rgba(248,250,252,.78) 72%,rgba(248,250,252,.96) 100%),
        url("https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?auto=format&fit=crop&w=2200&q=90");
    background-size:cover;
    background-position:center;
