...
<head>
    ...
    <style>
        *{box-sizing:border-box}
        ...
        .hero{min-height:100vh;position:relative;overflow:hidden;background:radial-gradient(circle at 50% 0%,rgba(250,204,21,.13),transparent 34%),linear-gradient(180deg,#090909,#050505)}
        ...
        .traffic-logo{width:48px;height:64px;border-radius:18px;background:#111;border:1px solid #2a2a2a;display:grid;place-items:center;padding:7px;box-shadow:0 20px 60px rgba(0,0,0,.35)}
        .lights{display:grid;gap:5px}
        .light{width:13px;height:13px;border-radius:50%;background:#333}
        ...
        h1{font-size:76px;line-height:.94;letter-spacing:-3.4px;margin:0 auto 24px;max-width:1000px}
        ...
        .screen{margin:28px auto 0;max-width:1080px;background:rgba(18,18,18,.88);border:1px solid rgba(255,255,255,.12);border-radius:38px;padding:18px;box-shadow:0 45px 140px rgba(0,0,0,.58);backdrop-filter:blur(18px)}
        ...
        .visual{min-height:360px;border-radius:28px;background:radial-gradient(circle at 50% 15%,rgba(250,204,21,.15),transparent 30%),linear-gradient(180deg,#191919,#0d0d0d);border:1px solid var(--line);position:relative;overflow:hidden}
        ...
        .exam-card{background:#0b0b0b;border:1px solid var(--line);border-radius:28px;padding:24px}
        ...
        .answer{padding:15px;border-radius:16px;background:#151515;border:1px solid var(--line);color:#d4d4d8;margin-top:10px;font-weight:850;display:flex;justify-content:space-between}
        ...
        .card{background:var(--card);border:1px solid var(--line);border-radius:32px;padding:30px;box-shadow:0 24px 80px rgba(0,0,0,.22);transition:.25s ease}
...
<section class="hero">
    ...
    <div class="container">
        ...
        <div class="center">
            <div class="badge">Traffic Light Learning System</div>

            <h1>წითელი შეცდომისთვის, ყვითელი სწავლისთვის, <span>მწვანე ჩაბარებისთვის</span></h1>

            <p class="lead">
                ავტოსკოლის პლატფორმა შუქნიშნის ლოგიკით: შეცდომა გაჩერებს, ახსნა გასწავლის,
                სწორი პასუხი კი გაძლევს მწვანე გზას გამოცდისკენ.
            </p>
...
<section class="section" id="platform">
    <div class="title">
        <h2>საიტის ლოგიკა პირდაპირ შუქნიშანზეა აგებული.</h2>
        <p>წითელი — შეცდომა, ყვითელი — ახსნა, მწვანე — სწორი პასუხი. მარტივი და დასამახსოვრებელი სისტემა.</p>
    </div>
