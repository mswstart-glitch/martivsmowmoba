...
:root{--y:#8b5cf6;--gold:#22d3ee;--gold2:#fb7185;--bg:#050514;--panel:#0b1020;--ink:#f8fafc;--muted:#a8b0c3;--line:rgba(139,92,246,.22)}
...
.hero{min-height:100vh;position:relative;overflow:hidden;background:radial-gradient(circle at 76% 28%,rgba(251,113,133,.30),transparent 24%),radial-gradient(circle at 18% 22%,rgba(139,92,246,.34),transparent 30%),radial-gradient(circle at 58% 78%,rgba(34,211,238,.22),transparent 30%),linear-gradient(120deg,#050514 0%,#0b1020 46%,#170923 72%,#030712 100%)}
...
.navbtn{background:linear-gradient(135deg,#fb7185,#8b5cf6,#22d3ee);color:#ffffff;padding:15px 24px;border-radius:16px;font-weight:950;box-shadow:0 18px 45px rgba(139,92,246,.18)}
...
h1 span{background:linear-gradient(90deg,#fb7185,#8b5cf6,#22d3ee);-webkit-background-clip:text;color:transparent}
...
.primary{background:linear-gradient(135deg,#fb7185,#8b5cf6,#22d3ee);color:#ffffff;box-shadow:0 18px 45px rgba(139,92,246,.22)}
...
.center h2 span{background:linear-gradient(90deg,#fb7185,#8b5cf6,#22d3ee);-webkit-background-clip:text;color:transparent}
.cards{display:grid;grid-template-columns:repeat(4,1fr);gap:20px}
.card{background:linear-gradient(180deg,rgba(255,255,255,.065),rgba(255,255,255,.025));border:1px solid rgba(139,92,246,.14);border-radius:30px;padding:32px;min-height:255px;box-shadow:0 24px 80px rgba(0,0,0,.28);transition:.18s;backdrop-filter:blur(16px)}
.card:hover{transform:translateY(-8px);border-color:rgba(139,92,246,.42);box-shadow:0 34px 100px rgba(139,92,246,.08)}
...
.course{border:1px solid rgba(139,92,246,.14);border-radius:26px;overflow:hidden;background:linear-gradient(180deg,rgba(255,255,255,.065),rgba(255,255,255,.025));box-shadow:0 20px 80px rgba(0,0,0,.26);transition:.18s;backdrop-filter:blur(16px)}
