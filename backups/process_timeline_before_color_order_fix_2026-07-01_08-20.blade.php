...
.ast-timeline__step:nth-child(1) .ast-timeline__node{border-color:#E5483F; color:#E5483F; animation:astFillRed 6s ease-in-out infinite;}
.ast-timeline__step:nth-child(2) .ast-timeline__node{border-color:#F2B72E; color:#B9840F; animation:astFillYellow 6s ease-in-out infinite;}
.ast-timeline__step:nth-child(3) .ast-timeline__node{border-color:#3FBF6E; color:#1F8A4C; animation:astFillGreen 6s ease-in-out infinite;}
