...
<style id="footer-road-continuation-v1">
    .section{
        position:relative !important;
        overflow:hidden !important;
        isolation:isolate !important;
    ...
    .section::before{
        ...
        background:
            linear-gradient(90deg,
                transparent 0 45%,
                rgba(31,111,255,.36) 45% 46%,
                transparent 46% 54%,
                rgba(31,111,255,.36) 54% 55%,
                transparent 55%
            ),
        ...
        transform:perspective(560px) rotateX(64deg) scaleX(.92) !important;
        transform-origin:top center !important;
        animation:footerRoadMove 7s linear infinite !important;
    ...
    @media(max-width:900px){
        .section::before{
            ...
            transform:perspective(560px) rotateX(64deg) scaleX(1.2) !important;
        }
