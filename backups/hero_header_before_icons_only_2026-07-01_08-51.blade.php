...
/* exact license category window style */
.ast-hero__categories{
    gap:18px !important;
    padding:24px clamp(20px,4vw,56px) 30px !important;
...
.ast-hero__plate{
    ...
    border:2px dashed #C9D7E8 !important;
...
.ast-hero__plate:hover{
    ...
    border-color:#155FC9 !important;
    box-shadow:0 14px 24px -18px rgba(11,30,61,.28) !important;
}
...
.ast-hero__plate.is-featured:hover{
    border-color:#155FC9 !important;
}

.ast-hero__plate-icon{
