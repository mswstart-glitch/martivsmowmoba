    ...
    .cinematic-hero:after{
        ...
        background:
            linear-gradient(90deg,
                transparent 0 45%,
                rgba(255,255,255,.72) 45% 46%,
                transparent 46% 54%,
                rgba(255,255,255,.72) 54% 55%,
                transparent 55%
            ),
            repeating-linear-gradient(
                115deg,
                transparent 0 46px,
                rgba(31,111,255,.16) 46px 56px,
                transparent 56px 100px
            ) !important;

        transform:perspective(560px) rotateX(64deg) !important;
        animation:heroRoadMove 7s linear infinite !important;
    }
