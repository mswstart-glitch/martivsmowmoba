...
<header class="hero">
    <div class="container hero-grid">
        <div class="hero-copy">
            ...
            <p class="hero-text">
                თეორია, პრაქტიკული გაკვეთილები და გამოცდის სიმულაცია ერთ თანამედროვე სივრცეში —
                მარტივად, მშვიდად და შედეგზე ორიენტირებულად.
            </p>
        ...
        <div class="exam-card">
            <div class="exam-head">
                ...
                <span class="exam-pill">A კატეგორია</span>
            </div>
