...
.ast-hero__aurora--a{width:560px; height:560px; top:-220px; right:-160px; background:radial-gradient(circle,rgba(21,95,201,0.16),transparent 70%);}
.ast-hero__aurora--b{width:420px; height:420px; bottom:-200px; left:-120px; background:radial-gradient(circle,rgba(95,168,245,0.14),transparent 70%);}
.ast-hero__particle{position:absolute; width:5px; height:5px; border-radius:50%; background:var(--blue-light); opacity:0.5; z-index:0; animation:astFloat 6s ease-in-out infinite;}
.ast-hero__route{position:absolute; inset:0; width:100%; height:100%; z-index:0; opacity:0.9; pointer-events:none;}
.ast-hero__nav-toggle-input{display:none;}

.ast-hero__bar{position:relative; z-index:2; display:flex; align-items:center; justify-content:space-between; gap:18px; padding:20px clamp(20px,4vw,56px); border-bottom:1px solid rgba(21,95,201,0.14); background:rgba(255,255,255,0.7); backdrop-filter:blur(10px);}
.ast-hero__logo{display:flex; align-items:center; gap:12px; text-decoration:none; color:inherit;}
.ast-hero__logo-mark{width:38px; height:38px; border-radius:50%; background:linear-gradient(155deg,var(--blue-light),var(--blue-deep)); display:flex; align-items:center; justify-content:center; color:#fff; font-size:19px; box-shadow:0 6px 16px -6px rgba(21,95,201,0.5);}
.ast-hero__logo-word{font-family:'Noto Serif Georgian'; font-weight:700; font-size:18px; letter-spacing:0.2px; color:var(--ink);}
...
.ast-hero__cta-ghost{font-family:'Space Mono'; font-size:12px; font-weight:700; letter-spacing:0.5px; color:#fff; background:linear-gradient(135deg,var(--blue-light),var(--blue-deep)); border-radius:3px; padding:10px 20px; text-decoration:none; box-shadow:0 10px 22px -10px rgba(11,62,134,0.65); transition:transform .25s ease, box-shadow .25s ease;}
.ast-hero__cta-ghost:hover{transform:translateY(-1px); box-shadow:0 14px 26px -10px rgba(11,62,134,0.75);}
.ast-hero__burger{display:none; color:var(--blue); font-size:22px; cursor:pointer;}

.ast-hero__body{position:relative; z-index:2; display:grid; grid-template-columns:1.2fr 0.9fr; gap:48px; align-items:center; padding:clamp(36px,6vw,76px) clamp(20px,4vw,56px) clamp(32px,5vw,60px);}
.ast-hero__copy{animation:astRise .8s cubic-bezier(.2,.7,.2,1) both;}
.ast-hero__eyebrow{display:inline-block; font-family:'Space Mono'; font-size:11px; font-weight:700; letter-spacing:2px; color:var(--blue-deep); background:var(--paper-tint); border:1px solid rgba(21,95,201,0.25); border-radius:2px; padding:5px 12px; margin-bottom:22px;}
...
.ast-hero__card{position:relative; width:270px; background:linear-gradient(155deg,#FFFFFF,#EAF0F8); border:1px solid var(--chrome); border-radius:14px; padding:20px; box-shadow:0 30px 60px -24px rgba(11,30,61,0.28), inset 0 0 0 1px rgba(255,255,255,0.6); transform:rotate(-4deg); transition:transform .4s ease; overflow:hidden;}
.ast-hero__card-shine{position:absolute; top:-50%; left:-60%; width:60%; height:200%; background:linear-gradient(75deg,transparent,rgba(95,168,245,0.35),transparent); transform:rotate(20deg); animation:astSweep 4.5s ease-in-out infinite;}
...
.ast-hero__card-photo{width:56px; height:56px; border-radius:8px; background:linear-gradient(155deg,var(--blue-light),var(--blue-deep)); display:flex; align-items:center; justify-content:center; color:#fff; font-size:28px; flex-shrink:0; box-shadow:0 8px 16px -8px rgba(21,95,201,0.5);}
.ast-hero__card-lines{flex:1; display:flex; flex-direction:column; gap:7px;}
.ast-hero__card-lines i{display:block; height:6px; border-radius:2px; background:rgba(11,30,61,0.12); font-style:normal;}
...
.ast-hero__seal{position:relative; margin-top:-86px; margin-left:182px; width:64px; height:64px; border-radius:50%; border:1.5px solid var(--blue); background:#fff; display:flex; align-items:center; justify-content:center; transform:rotate(12deg); box-shadow:0 10px 20px -8px rgba(11,30,61,0.3);}
...
.ast-hero__stat{font-family:'Space Mono'; font-size:12px; font-weight:700; color:var(--blue-deep); background:var(--paper-tint); border:1px solid rgba(21,95,201,0.3); border-radius:3px; padding:8px 16px;}

.ast-hero__perforation{position:relative; z-index:2; height:1px; margin:0 clamp(20px,4vw,56px); background-image:radial-gradient(circle, rgba(21,95,201,0.35) 1.5px, transparent 1.5px); background-size:14px 1px; background-repeat:repeat-x;}
...
.ast-hero__plate:hover{border-color:var(--blue); transform:translateY(-3px); box-shadow:0 10px 18px -10px rgba(21,95,201,0.35);}
.ast-hero__plate.is-featured{border-color:var(--blue); background:linear-gradient(155deg,rgba(21,95,201,0.10),rgba(95,168,245,0.04));}
...
@media (prefers-reduced-motion: reduce){
    .ast-hero__title,.ast-hero__card-shine,.ast-hero__copy,.ast-hero__card-wrap,.ast-hero__particle{animation:none;}
}
</style>
</head>
