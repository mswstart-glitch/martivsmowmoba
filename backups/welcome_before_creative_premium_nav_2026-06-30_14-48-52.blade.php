...
<style id="hard-premium-navbar-final">
    body nav,
    body header,
    body .nav,
    body .navbar,
    ...
    body .navigation{
        ...
        background:
            linear-gradient(135deg, rgba(8,19,35,.94), rgba(14,36,66,.86)) !important;
    ...
    body .brand-mark{
        ...
        background:
            radial-gradient(circle at 28% 22%, rgba(255,255,255,.62), transparent 30%),
            linear-gradient(135deg,#74bdff,#2368ff) !important;
        box-shadow:0 18px 45px rgba(47,128,255,.42) !important;
    }
    ...
    body .nav-cta{
        ...
        background:linear-gradient(135deg,#79c2ff,#2f72ff) !important;
        box-shadow:0 22px 58px rgba(47,128,255,.42) !important;
        transform:none !important;
    }
...
<script id="hard-disable-navbar-motion-final">
(function(){
    function fixNav(){
        const nav = document.querySelector("nav, header, .nav, .navbar, .site-nav, .main-nav, .top-nav, .topbar, .navigation");
        if(!nav) return;
        ...
        if(window.ScrollTrigger){
            ScrollTrigger.getAll().forEach(function(st){
                ...
                if(anim && anim.targets && anim.targets().includes(nav)){
                    st.kill();
                }
            });
        }
