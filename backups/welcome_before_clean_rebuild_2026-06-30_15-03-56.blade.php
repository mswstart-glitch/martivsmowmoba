...
<style id="clean-premium-navbar-final-v1">
    .nav{
        position:fixed !important;
        top:22px !important;
        left:50% !important;
        ...
        border:1px solid rgba(70,135,255,.20) !important;

        backdrop-filter:blur(24px) saturate(180%) !important;
        -webkit-backdrop-filter:blur(24px) saturate(180%) !important;

        box-shadow:
            0 24px 65px rgba(15,70,145,.18),
    ...
    .brand-mark{
        ...
        background:
            radial-gradient(circle at 30% 24%, rgba(255,255,255,.68), transparent 30%),
            linear-gradient(135deg,#69b8ff,#2368ff) !important;
        box-shadow:
            0 14px 30px rgba(47,128,255,.32),
    ...
    .nav-links .nav-cta{
        ...
        background:
            radial-gradient(circle at 28% 18%, rgba(255,255,255,.45), transparent 32%),
            linear-gradient(135deg,#3b8dff,#1557e8) !important;

        box-shadow:
            0 16px 36px rgba(47,128,255,.36),
    ...
    .nav-links .nav-cta:hover{
        color:#fff !important;
        background:
            radial-gradient(circle at 28% 18%, rgba(255,255,255,.50), transparent 32%),
            linear-gradient(135deg,#4b98ff,#1d63ff) !important;
        box-shadow:
            0 18px 44px rgba(47,128,255,.45),
...
<script id="clean-premium-navbar-lock-final-v1">
