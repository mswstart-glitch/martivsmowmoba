...
<style id="road-continuation-v1">
    ...
    .cinematic-hero:after{
        ...
        background:
            linear-gradient(90deg,
                transparent 0 42%,
                rgba(255,255,255,.82) 42% 43%,
                transparent 43% 57%,
                rgba(255,255,255,.82) 57% 58%,
                transparent 58% 100%
            ),
            repeating-linear-gradient(
                115deg,
                transparent 0 46px,
                rgba(31,111,255,.18) 46px 56px,
    ...
    body::before{
        ...
        transform:translateX(-50%) perspective(720px) rotateX(62deg) translateY(38vh) !important;
        ...
        background:
            linear-gradient(90deg,
                transparent 0 45%,
                rgba(31,111,255,.34) 45% 46%,
                transparent 46% 54%,
                rgba(31,111,255,.34) 54% 55%,
                transparent 55% 100%
            ),
            repeating-linear-gradient(
                180deg,
                transparent 0 54px,
                rgba(31,111,255,.16) 54px 68px,
                transparent 68px 120px
            ) !important;
        mask-image:linear-gradient(180deg,transparent 0%,black 20%,black 78%,transparent 100%) !important;
        -webkit-mask-image:linear-gradient(180deg,transparent 0%,black 20%,black 78%,transparent 100%) !important;
        animation:bodyRoadMove 8s linear infinite !important;
    }

    @keyframes bodyRoadMove{
        from{background-position:0 0,0 0}
