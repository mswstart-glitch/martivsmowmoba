...
<style id="premium-fixed-navbar-v3">
    .nav,
    header,
    .navbar{
        ...
        background:
            linear-gradient(135deg, rgba(18,34,55,.92), rgba(13,28,48,.84)) !important;
        border: 1px solid rgba(190,220,255,.22) !important;
        box-shadow:
    ...
    .logo-mark{
        ...
        background:linear-gradient(135deg,#5aa2ff,#2268ff) !important;
        box-shadow:0 16px 38px rgba(47,128,255,.32) !important;
    }
    ...
    .menu .nav-cta{
        ...
        box-shadow:
            0 20px 55px rgba(47,128,255,.34),
    ...
    .nav-cta:hover{
        ...
        box-shadow:
            0 24px 65px rgba(47,128,255,.46),
            inset 0 1px 0 rgba(255,255,255,.25) !important;
    }
...
<style id="navbar-premium-static-final">
    .nav,
    header.nav,
    .navbar{
        position:fixed !important;
        ...
        background:
            linear-gradient(135deg, rgba(12,25,43,.88), rgba(18,39,68,.76)) !important;
    ...
    .brand-mark{
        ...
        background:
            ...
            linear-gradient(135deg,#68b3ff,#1d63ff) !important;
        box-shadow:
            0 18px 42px rgba(47,128,255,.38),
    ...
    .nav-links a:not(.nav-cta)::after{
        ...
        height:2px !important;
        border-radius:999px !important;
        background:linear-gradient(90deg,#6bb6ff,#2f72ff) !important;
        transform:scaleX(0) !important;
    ...
    .nav-cta{
        ...
        background:
            ...
            linear-gradient(135deg,#72bdff,#2d6cff) !important;
        box-shadow:
            0 20px 55px rgba(47,128,255,.38),
    ...
    .nav-cta:hover{
        ...
        transform:none !important;
        box-shadow:
            0 24px 65px rgba(47,128,255,.48),
            inset 0 1px 0 rgba(255,255,255,.38) !important;
    }
...
<script id="disable-navbar-motion-v3">
document.addEventListener("DOMContentLoaded", function(){
    if (typeof gsap !== "undefined") {
        gsap.killTweensOf(".nav, header, .navbar");
        if (typeof ScrollTrigger !== "undefined") {
            ScrollTrigger.getAll().forEach(function(st){
                var t = st.vars && st.vars.trigger;
                if (t === ".nav" || t === "header" || t === ".navbar" || t === "body") {
                    st.kill();
                }
            });
        }
    ...
    document.querySelectorAll(".nav, header, .navbar").forEach(function(el){
...
<script id="navbar-disable-motion-final">
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (typeof gsap !== "undefined") {
        ...
        if (typeof ScrollTrigger !== "undefined") {
            ScrollTrigger.getAll().forEach(function(st){
                const trig = st.vars && st.vars.trigger;
                const targets = st.vars && st.vars.animation && st.vars.animation.targets ? st.vars.animation.targets() : [];

                if (
                    trig === ".nav" ||
                    trig === ".navbar" ||
                    trig === "header" ||
                    targets.some(function(t){ return t && t.classList && (t.classList.contains("nav") || t.classList.contains("navbar")); })
                ) {
                    st.kill();
                }
            });
