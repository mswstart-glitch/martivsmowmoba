...
:root{--y:#d8b45a;--gold:#d8b45a;--gold2:#f2d98b;--bg:#070911;--panel:#0d111c;--ink:#f8f5ec;--muted:#a8adbb;--line:rgba(216,180,90,.18)}
html.lenis{height:auto}
.lenis.lenis-smooth{scroll-behavior:auto}
body{margin:0;background:#070911;color:var(--ink);font-family:system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;overflow-x:hidden}
a{text-decoration:none;color:inherit}
.wrap{max-width:1240px;margin:auto;padding:0 34px}
.hero{min-height:100vh;position:relative;overflow:hidden;background:radial-gradient(circle at 72% 35%,rgba(216,180,90,.22),transparent 24%),radial-gradient(circle at 12% 20%,rgba(35,65,120,.38),transparent 28%),linear-gradient(90deg,#070911 0%,#0a0f1c 48%,rgba(10,15,28,.72) 72%,#06070d 100%)}
.road{position:absolute;right:-170px;bottom:-260px;width:820px;height:760px;transform:perspective(720px) rotateX(64deg) rotateZ(-12deg);background:linear-gradient(90deg,#05070c,#121826 48%,#2a2d33 50%,#121826 52%,#05070c)}
.road:after{content:"";position:absolute;left:50%;top:0;width:9px;height:100%;transform:translateX(-50%);background:repeating-linear-gradient(to bottom,var(--gold) 0 44px,transparent 44px 92px);filter:drop-shadow(0 0 16px rgba(216,180,90,.65))}
.car{position:absolute;right:120px;bottom:210px;width:500px;height:180px;border-radius:140px 140px 36px 36px;background:linear-gradient(180deg,#1b2130,#06070d 62%,#020308);box-shadow:0 50px 110px rgba(0,0,0,.38)}
.car:before{content:"";position:absolute;left:18%;right:18%;top:-76px;height:118px;border-radius:110px 110px 16px 16px;background:linear-gradient(180deg,#242b3c,#090b12)}
...
.l1,.l2{position:absolute;top:68px;width:145px;height:40px;background:linear-gradient(90deg,#fff3c4,var(--gold));box-shadow:0 0 42px rgba(216,180,90,.75),0 0 130px rgba(216,180,90,.32)}
...
.mark{width:42px;height:42px;border-radius:14px;background:linear-gradient(180deg,#111827,#05070c);color:var(--gold);border:1px solid var(--line);display:grid;place-items:center;box-shadow:0 18px 45px rgba(216,180,90,.12)}
.menu{display:flex;gap:38px;font-weight:800;font-size:15px}
.navbtn{background:linear-gradient(135deg,var(--gold2),var(--gold));color:#090b12;padding:15px 24px;border-radius:16px;font-weight:950;box-shadow:0 18px 45px rgba(216,180,90,.18)}
...
h1 span{background:linear-gradient(90deg,var(--gold2),var(--gold));-webkit-background-clip:text;color:transparent}
...
.primary{background:linear-gradient(135deg,var(--gold2),var(--gold));color:#090b12;box-shadow:0 18px 45px rgba(216,180,90,.22)}
...
.avatar{width:34px;height:34px;border-radius:50%;background:linear-gradient(135deg,#1d2433,#d8b45a);border:2px solid #070911;display:inline-block;margin-left:-8px}
.avatar:first-child{margin-left:0}

.section{padding:90px 34px;background:#070911}
...
.center h2 span{background:linear-gradient(90deg,var(--gold2),var(--gold));-webkit-background-clip:text;color:transparent}
.cards{display:grid;grid-template-columns:repeat(4,1fr);gap:20px}
.card{background:linear-gradient(180deg,rgba(255,255,255,.065),rgba(255,255,255,.025));border:1px solid rgba(216,180,90,.14);border-radius:30px;padding:32px;min-height:255px;box-shadow:0 24px 80px rgba(0,0,0,.28);transition:.35s;backdrop-filter:blur(16px)}
.card:hover{transform:translateY(-8px);border-color:rgba(216,180,90,.42);box-shadow:0 34px 100px rgba(216,180,90,.08)}
.ico{width:58px;height:58px;border-radius:19px;background:linear-gradient(180deg,#111827,#05070c);border:1px solid rgba(216,180,90,.18);color:var(--gold);display:grid;place-items:center;font-size:24px;margin-bottom:30px}
.card h3{font-size:22px;margin:0 0 12px;color:var(--ink)}.card p{color:var(--muted);line-height:1.65;margin:0}

.dark{background:linear-gradient(180deg,#05070c,#090d17);color:white;overflow:hidden;border-top:1px solid rgba(216,180,90,.12);border-bottom:1px solid rgba(216,180,90,.12)}
...
.step{padding:22px}
.num{width:62px;height:62px;border-radius:50%;border:1px solid rgba(216,180,90,.4);color:var(--gold);display:grid;place-items:center;font-weight:950;margin-bottom:22px}
...
.course{border:1px solid rgba(216,180,90,.14);border-radius:26px;overflow:hidden;background:linear-gradient(180deg,rgba(255,255,255,.065),rgba(255,255,255,.025));box-shadow:0 20px 80px rgba(0,0,0,.26);transition:.35s;backdrop-filter:blur(16px)}
.thumb{height:160px;background:linear-gradient(135deg,#131a29,#090d17);position:relative;overflow:hidden}
.thumb:after{content:"";position:absolute;inset:0;background:radial-gradient(circle at 70% 40%,rgba(216,180,90,.45),transparent 25%)}
