...
.real-road-bg{
    ...
    opacity:0;
    background:
        linear-gradient(180deg,rgba(248,250,252,.96) 0%,rgba(248,250,252,.78) 22%,rgba(248,250,252,.74) 72%,rgba(248,250,252,.96) 100%),
...
<script id="real-road-scroll-bg-js">
document.addEventListener('DOMContentLoaded', () => {
    if(window.gsap && window.ScrollTrigger){
        gsap.to('.real-road-bg', {
            scrollTrigger:{
                trigger:'#features',
                start:'top 80%',
                end:'bottom bottom',
