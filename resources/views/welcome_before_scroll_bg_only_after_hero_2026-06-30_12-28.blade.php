...
.hero{
    ...
    color:#fff;
    background:
        linear-gradient(90deg,rgba(7,17,31,.92) 0%,rgba(7,17,31,.58) 50%,rgba(7,17,31,.72) 100%),
...
.badge{display:inline-flex;padding:7px 11px;border-radius:999px;background:var(--green-soft);color:#15803D;font-size:12px;font-weight:900;margin-bottom:16px}
