...
.hero{
    ...
    color:#fff;
    background:
        linear-gradient(90deg,rgba(7,17,31,.92) 0%,rgba(7,17,31,.66) 48%,rgba(7,17,31,.35) 100%),
...
.hero:after{
    ...
    position:absolute;
    inset:0;
    background:linear-gradient(180deg,transparent 0%,rgba(7,17,31,.2) 70%,var(--bg) 100%);
    pointer-events:none;
}
...
.package.featured{
    ...
    box-shadow:0 20px 55px rgba(34,197,94,.12);
}
...
.hero:before{
    ...
    z-index:0;
    background:
        linear-gradient(90deg, rgba(7,17,31,.94) 0%, rgba(7,17,31,.76) 42%, rgba(7,17,31,.88) 100%);
    pointer-events:none;
}
...
.hero:after{
    ...
    background:
        repeating-linear-gradient(
            to bottom,
            transparent 0 52px,
            rgba(255,255,255,.62) 52px 92px,
            transparent 92px 150px
        ),
        linear-gradient(90deg,
            rgba(255,255,255,.16) 0 1px,
            transparent 1px 49%,
            rgba(255,255,255,.20) 49% 51%,
            transparent 51% calc(100% - 1px),
            rgba(255,255,255,.16) calc(100% - 1px) 100%
        ),
        #0B1422;
    background-size:
        8px 150px,
    ...
    opacity:.65;
    box-shadow:0 0 120px rgba(0,0,0,.58);
    pointer-events:none;
}
...
.hero .road-light.green{
    left:18%;
    top:30%;
    background:#22C55E;
    box-shadow:0 0 28px rgba(34,197,94,.9),0 0 90px rgba(34,197,94,.28);
}
...
.hero .road-light.red{
    ...
    top:26%;
    background:#EF4444;
    box-shadow:0 0 28px rgba(239,68,68,.9),0 0 90px rgba(239,68,68,.28);
}

.hero .road-light.yellow{
    right:12%;
    top:49%;
    background:#F59E0B;
    box-shadow:0 0 28px rgba(245,158,11,.85),0 0 90px rgba(245,158,11,.22);
}
...
.road-scroll-bg:before{
    ...
    background:
        repeating-linear-gradient(
            to bottom,
            rgba(15,23,42,.22) 0 44px,
            transparent 44px 94px
        ),
        linear-gradient(90deg,
            rgba(15,23,42,.20) 0 1px,
            transparent 1px calc(50% - 3px),
            rgba(15,23,42,.34) calc(50% - 3px) calc(50% + 3px),
            transparent calc(50% + 3px) calc(100% - 1px),
            rgba(15,23,42,.20) calc(100% - 1px) 100%
        ),
        #E2E8F0;
...
<section class="hero">
        ...
        <span class="road-light green"></span>
        <span class="road-light red"></span>
        <span class="road-light yellow"></span>
...
<section class="section" id="features">
    <div class="container">
        ...
        <div class="grid-4">
            <div class="card">
                <div class="card-top"><span class="card-icon">01</span><span>01</span></div>
                <h3>ფიზიკური კურსი</h3>
                <p>ინსტრუქტორთან სწავლა და გამოცდაზე ორიენტირებული ახსნა.</p>
            </div>
            <div class="card">
                <div class="card-top"><span class="card-icon">02</span><span>02</span></div>
                <h3>ონლაინ თეორია</h3>
                <p>ისწავლე სახლიდან, გზაში ან შესვენებაზე — ნებისმიერ მოწყობილობაზე.</p>
            </div>
            <div class="card">
                <div class="card-top"><span class="card-icon">03</span><span>03</span></div>
                <h3>გამოცდის სიმულაცია</h3>
                <p>რეალურ გამოცდასთან მიახლოებული დრო, კითხვები და შედეგები.</p>
            </div>
            <div class="card">
                <div class="card-top"><span class="card-icon">04</span><span>04</span></div>
...
<script id="css-road-hero-animation">
document.addEventListener('DOMContentLoaded', () => {
    if(window.gsap){
        gsap.to('.hero:after', {opacity:.8});
        gsap.to('.road-light.green', {opacity:.35, duration:1.2, repeat:-1, yoyo:true, ease:'sine.inOut'});
        gsap.to('.road-light.red', {opacity:.3, duration:1.45, repeat:-1, yoyo:true, ease:'sine.inOut'});
        gsap.to('.road-light.yellow', {opacity:.25, duration:1.7, repeat:-1, yoyo:true, ease:'sine.inOut'});
    }
});
</script>


<script id="scroll-road-vibe-animation">
document.addEventListener('DOMContentLoaded', () => {
    if(window.gsap && window.ScrollTrigger){
        gsap.to('.road-scroll-bg:before', {
            y: 240
        });

        gsap.to('.road-scroll-bg', {
            scrollTrigger:{
                trigger:'body',
                start:'top top',
                end:'bottom bottom',
