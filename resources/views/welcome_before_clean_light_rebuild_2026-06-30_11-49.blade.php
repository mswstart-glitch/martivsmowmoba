...
<style>
html,body{font-family:'Plus Jakarta Sans', Arial, sans-serif !important;}
h1,h2,h3,h4,h5,h6{font-family:'Plus Jakarta Sans', Arial, sans-serif !important;font-weight:800;letter-spacing:-0.05em;}
p,span,a,button,input,textarea{font-family:'Plus Jakarta Sans', Arial, sans-serif !important;}
</style>
...
<link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@200;300;400;500;600;700;800&display=swap&v=20260630" rel="stylesheet">
...
<style id="georgian-premium-font">
html,
body,
body *,
button,
...
<style id="remove-gold-final-blue-theme">
:root{
    --gold:#60A5FA !important;
    --cream:#F8FAFC !important;
    --dark:#050B14 !important;
...
section{
    background:
        radial-gradient(circle at 18% 16%, rgba(59,130,246,.16), transparent 34%),
        radial-gradient(circle at 80% 75%, rgba(96,165,250,.10), transparent 36%),
        linear-gradient(180deg,#07111F 0%,#050B14 100%) !important;
}
...
.floating-score{
    background:
        linear-gradient(145deg,rgba(17,31,52,.92),rgba(7,17,31,.74)) !important;
    color:#F8FAFC !important;
...
.result-card strong{
    ...
    text-shadow:0 0 32px rgba(96,165,250,.34) !important;
}
...
.final-cta{
    background:
        radial-gradient(circle at 82% 18%, rgba(96,165,250,.22), transparent 34%),
        linear-gradient(135deg,#07111F 0%,#0B1728 50%,#050B14 100%) !important;
    color:#F8FAFC !important;
}

.cta-orb{
    background:radial-gradient(circle,#60A5FA 0%,rgba(59,130,246,.25) 44%,transparent 72%) !important;
}
...
button[type="submit"]{
    ...
    box-shadow:0 18px 55px rgba(59,130,246,.32) !important;
}
...
<style id="clean-two-color-final-theme">
:root{
    --site-bg:#07111F;
    --site-primary:#3B82F6;
    --site-card:#101B2D;
    ...
    --site-text:#FFFFFF;
    --site-muted:rgba(255,255,255,.64);
}
