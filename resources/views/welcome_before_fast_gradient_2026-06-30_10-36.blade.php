...
:root{--y:#5eead4;--gold:#5eead4;--gold2:#a7f3d0;--bg:#050816;--panel:#0d111c;--ink:#f8f5ec;--muted:#a8adbb;--line:rgba(94,234,212,.18)}
...
.hero{min-height:100vh;position:relative;overflow:hidden;background:radial-gradient(circle at 72% 35%,rgba(94,234,212,.24),transparent 24%),radial-gradient(circle at 18% 18%,rgba(56,189,248,.24),transparent 28%),radial-gradient(circle at 55% 100%,rgba(167,243,208,.12),transparent 30%),linear-gradient(90deg,#050816 0%,#070b1f 48%,rgba(3,7,18,.72) 72%,#030712 100%)}
...
.road:after{content:"";position:absolute;left:50%;top:0;width:9px;height:100%;transform:translateX(-50%);background:repeating-linear-gradient(to bottom,var(--gold) 0 44px,transparent 44px 92px);filter:drop-shadow(0 0 16px rgba(94,234,212,.65))}
...
.l1,.l2{position:absolute;top:68px;width:145px;height:40px;background:linear-gradient(90deg,#fff3c4,var(--gold));box-shadow:0 0 42px rgba(94,234,212,.75),0 0 130px rgba(94,234,212,.32)}
...
.mark{width:42px;height:42px;border-radius:14px;background:linear-gradient(180deg,#0f172a,#030712);color:var(--gold);border:1px solid var(--line);display:grid;place-items:center;box-shadow:0 18px 45px rgba(94,234,212,.12)}
.menu{display:flex;gap:38px;font-weight:800;font-size:15px}
.navbtn{background:linear-gradient(135deg,#a7f3d0,#5eead4,#38bdf8);color:#020617;padding:15px 24px;border-radius:16px;font-weight:950;box-shadow:0 18px 45px rgba(94,234,212,.18)}
...
h1 span{background:linear-gradient(90deg,#a7f3d0,#5eead4,#38bdf8);-webkit-background-clip:text;color:transparent}
...
.primary{background:linear-gradient(135deg,#a7f3d0,#5eead4,#38bdf8);color:#020617;box-shadow:0 18px 45px rgba(94,234,212,.22)}
...
.avatar{width:34px;height:34px;border-radius:50%;background:linear-gradient(135deg,#1e293b,#5eead4);border:2px solid #050816;display:inline-block;margin-left:-8px}
...
.center h2 span{background:linear-gradient(90deg,#a7f3d0,#5eead4,#38bdf8);-webkit-background-clip:text;color:transparent}
.cards{display:grid;grid-template-columns:repeat(4,1fr);gap:20px}
.card{background:linear-gradient(180deg,rgba(255,255,255,.065),rgba(255,255,255,.025));border:1px solid rgba(94,234,212,.14);border-radius:30px;padding:32px;min-height:255px;box-shadow:0 24px 80px rgba(0,0,0,.28);transition:.35s;backdrop-filter:blur(16px)}
.card:hover{transform:translateY(-8px);border-color:rgba(94,234,212,.42);box-shadow:0 34px 100px rgba(94,234,212,.08)}
.ico{width:58px;height:58px;border-radius:19px;background:linear-gradient(180deg,#0f172a,#030712);border:1px solid rgba(94,234,212,.18);color:var(--gold);display:grid;place-items:center;font-size:24px;margin-bottom:30px}
.card h3{font-size:22px;margin:0 0 12px;color:var(--ink)}.card p{color:var(--muted);line-height:1.65;margin:0}

.dark{background:linear-gradient(180deg,#030712,#070b1f);color:white;overflow:hidden;border-top:1px solid rgba(94,234,212,.12);border-bottom:1px solid rgba(94,234,212,.12)}
...
.step{padding:22px}
.num{width:62px;height:62px;border-radius:50%;border:1px solid rgba(94,234,212,.4);color:var(--gold);display:grid;place-items:center;font-weight:950;margin-bottom:22px}
...
.course{border:1px solid rgba(94,234,212,.14);border-radius:26px;overflow:hidden;background:linear-gradient(180deg,rgba(255,255,255,.065),rgba(255,255,255,.025));box-shadow:0 20px 80px rgba(0,0,0,.26);transition:.35s;backdrop-filter:blur(16px)}
.thumb{height:160px;background:linear-gradient(135deg,#0f172a,#070b1f);position:relative;overflow:hidden}
.thumb:after{content:"";position:absolute;inset:0;background:radial-gradient(circle at 70% 40%,rgba(94,234,212,.45),transparent 25%)}
