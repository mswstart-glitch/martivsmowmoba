...
.ast-hero__plate-action{
text-decoration:none;
justify-content:center;
}

.ast-hero__action-icon{
width:28px;
height:28px;
border-radius:50%;
display:flex;
...
.ast-hero__plate-action.is-exam{
background:var(--blue-deep);
border-color:var(--blue-deep);
color:#fff;
}

.ast-hero__plate-action.is-exam .ast-hero__plate-code{
color:#fff;
}

.ast-hero__plate-action.is-exam .ast-hero__action-icon{
background:#fff;
color:var(--blue-deep);
}

.ast-hero__plate-action.is-tests{
background:#fff;
border:1px solid var(--blue-deep);
}

.ast-hero__plate-action.is-tests .ast-hero__action-icon{
